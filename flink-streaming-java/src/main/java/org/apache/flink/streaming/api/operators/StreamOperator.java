...
public interface StreamOperator<OUT> extends Serializable {
	 ...
	 */
	void setup(StreamTask<?, ?> containingTask, StreamConfig config, Output<StreamRecord<OUT>> output, Output<StreamRecord<Object>> sideOutput);
	 ...
	 *
	 * <p>This method is called after {@link #setup(StreamTask, StreamConfig, Output, Output)}
